				...
				<view class="wrap-item content">
					...
					<view class="content-sinopay">
						<el-row type="flex" align="middle">
							...
							<el-col>
								<view class="sinopay-info">1100000187</view>
							</el-col>
						</el-row>
						<el-row type="flex" align="middle">
							<el-col :span="5" class="sinopay-label-col">
							...
							<el-col>
								<view class="sinopay-info">13588270052</view>
							</el-col>
						</el-row>
						<el-row type="flex" align="middle">
							<el-col :span="5" class="sinopay-label-col">
						...
						<el-row type="flex" align="middle">
							<el-col :span="5" class="sinopay-label-col">
								<view class="sinopay-label">所属银行</view>
							</el-col>
							<el-col>
						...
						<el-row type="flex" align="middle">
							...
							<el-col>
								<view class="sinopay-info">中国农业银行股份有限公司</view>
							</el-col>
						</el-row>
						<el-row type="flex" align="middle">
							<el-col :span="5" class="sinopay-label-col">
							...
							<el-col>
								<view class="sinopay-info">330****2326</view>
							</el-col>
						</el-row>
						<el-row type="flex" align="middle">
							<el-col :span="5" class="sinopay-label-col">
							...
							<el-col>
								<view class="sinopay-info">已绑定</view>
							</el-col>
						</el-row>
						<el-row type="flex" align="middle">
							<el-col :span="5" class="sinopay-label-col">
							...
							<el-col>
								<view class="sinopay-info">2021-11-02 08:31:40</view>
							</el-col>
						</el-row>
						<el-row type="flex" align="middle">
							<el-col :span="5" class="sinopay-label-col">
							...
							<el-col>
								<view class="sinopay-info">
									<el-button plain type="primary" size="mini">解绑</el-button>
								</view>
							</el-col>
						</el-row>
					</view>
